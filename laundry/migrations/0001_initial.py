...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'laundry_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('will_pickup', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('dropoff', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('street_address', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
        ...
        db.send_create_signal(u'laundry', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'laundry_userprofile')
    ...
    models = {
        ...
        u'laundry.service': {
            'Meta': {'object_name': 'Service', 'db_table': "u'service'", 'managed': 'False'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'service_id': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        ...
        u'laundry.userprofile': {
            ...
            'dropoff': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'max_length': '2', 'blank': 'True'}),
            'street_address': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
            'will_pickup': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
